    ...
    <nav class="container container--70">
        <ul class="nav--actions">
            <li class="logged-user">
                ...
                <ul class="dropdown">
                    <li><a href="http://localhost:8080/app/update/${user.id}">Profil</a></li>
...
<section class="form--steps">
    ...
    <div class="form--steps-container">
        ...
        <form:form action="/app/form-confirmation" method="post" modelAttribute="donation">
            <!-- STEP 1: class .active is switching steps -->
            <div data-step="1" class="active">
                <h3>Zaznacz co chcesz oddać:</h3>

                <form:checkboxes path="categories"  cssClass="form-section--checkboxes" itemLabel="name" items="${categories}"/>
            ...
            <div data-step="3">
                <h3>Wybierz organizacje, której chcesz pomóc:</h3>
                    <form:checkboxes  path="institutions"  cssClass="checkbox" className="institutions"
                                     itemLabel="name"  items="${institutions}"/>
                <div class="form-group form-group--buttons">
                    <button type="button" class="btn prev-step">Wstecz</button>
                    <button type="button" class="btn next-step">Dalej</button>
                </div>
                ...
                <div class="summary">
                    ...
                    <div class="form-section form-section--columns">
                        ...
                        <div class="form-section--column">
                            <h4>Termin odbioru:</h4>
                            <ul>
                                <li id="17">13/12/2018</li>
                                <li id="18">15:40</li>
                                <li id="19">Brak uwag</li>
                            </ul>
                        </div>
                    </div>
                </div>
