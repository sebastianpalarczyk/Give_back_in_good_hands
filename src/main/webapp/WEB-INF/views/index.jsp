...
<section class="steps">
    ...
    <a href="http://localhost:8080/register" class="btn btn--large">Załóż konto</a>
</section>
...
<section class="help">
    ...
    <div class="help--slides active" data-id="1">
        ...
        <ul class="help--slides-items">
            <li>
                <c:forEach items="${institutions}" var="institution" begin="0" end="3">
                <div class="col">
